...
ZLOption::ZLOption(const ZLCategoryKey &category, const std::string &groupName, const std::string &optionName) 
	: myCategory(category), myGroupName(groupName), myOptionName(optionName), myIsSynchronized(false) 
{
}
...
ZLBooleanOption::ZLBooleanOption(const ZLCategoryKey &category, const std::string &groupName, const std::string &optionName, bool defaultValue)
   	: ZLSimpleOption(category, groupName, optionName), myDefaultValue(stringToBoolean(getDefaultConfigValue(), defaultValue)) 
{
